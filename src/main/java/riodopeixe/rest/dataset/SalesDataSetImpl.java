...
public class SalesDataSetImpl implements SalesDataSet {
    ...
    public List<Sales> listSales(Date initialDate, Date finalDate) {
        ...
        String jpql = ("SELECT \n"
                ...
                + "                                     pmi.datamovimento BETWEEN :initialdate AND :finaldate AND                                     \n"
                ...
                + "                                     its.datamovimento BETWEEN :initialdate AND :finaldate AND\n"
        ...
        List<Sales> sales = MANAGER.createNativeQuery(jpql, Sales.class).setParameter("initialdate", initialDate).setParameter("finaldate", finalDate).getResultList();
        return sales;
